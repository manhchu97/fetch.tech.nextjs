...
export const HEADER_CONFIG = [
  {
    ...
    render: () => ({
      ...
      imageSource: '/images/ServiceTheme1.png',
  ...
  },
  {
    ...
    render: () => ({
      ...
      imageSource: '/images/ServiceTheme2.png',
  ...
  },
  {
    ...
    render: () => ({
      ...
      imageSource: '/images/ServiceTheme3.png',
  ...
  },
  {
    ...
    render: () => ({
      ...
      imageSource: '/images/ServiceTheme4.png',
...
export const SERVICE_BODY_CONFIG = [
  {
    ...
    render: () => [
      {
        featureTheme: '/images/ServiceFeatureTheme1.png',
      ...
      {
        featureTheme: '/images/ServiceFeatureTheme2.png',
      ...
      {
        featureTheme: '/images/ServiceFeatureTheme3.png',
      ...
      {
        featureTheme: '/images/ServiceFeatureTheme4.png',
      ...
      {
        featureTheme: '/images/ServiceFeatureTheme5.png',
      ...
      {
        featureTheme: '/images/ServiceFeatureTheme6.png',
  ...
  },
  {
    ...
    render: () => [
      {
        featureTheme: '/images/ServiceFeatureTheme7.png',
      ...
      {
        featureTheme: '/images/ServiceFeatureTheme8.png',
      ...
      {
        featureTheme: '/images/ServiceFeatureTheme9.png',
      ...
      {
        featureTheme: '/images/ServiceFeatureTheme10.png',
  ...
  },
  {
    ...
    render: () => [
      {
        featureTheme: '/images/ServiceFeatureTheme11.png',
      ...
      {
        featureTheme: '/images/ServiceFeatureTheme12.png',
      ...
      {
        featureTheme: '/images/ServiceFeatureTheme13.png',
      ...
      {
        featureTheme: '/images/ServiceFeatureTheme14.png',
  ...
  },
  {
    ...
    render: () => [
      {
        featureTheme: '/images/ServiceFeatureTheme15.png',
        featureTitle:
      ...
      {
        featureTheme: '/images/ServiceFeatureTheme16.png',
      ...
      {
        featureTheme: '/images/ServiceFeatureTheme17.png',
        featureTitle: 'Step 2: Execution',
        featureSubtitle:
          'We bring you access to the best techies you can find in Vietnam through our vast recruitment network.',
      },
      {
        featureTheme: '/images/ServiceFeatureTheme18.png',
