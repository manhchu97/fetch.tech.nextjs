...
const Introduction = (): React.ReactElement => {
  ...
  useEffect(() => {
    const onScroll = () => {
      const _handle = ldDebounce(() => {
        const arrContentDOM = document.querySelectorAll('.card-container')
        ...
        arrContentDOM.forEach((contentDOM) => {
          ...
          const isMovedContentDOM = top <= 100 && -top <= height + 100
        ...
        <div className='sidebar-container'>
          <div className='sidebar'>
            ...
            <div className='sidebar-content-container'>
              <div className='sidebar-content' data-option='ft-refer-friends-0'>
                <div className='h6'>Giới thiệu người tham gia</div>
              </div>

              <div
                className='sidebar-content'
                data-option='ft-why-should-chose-we-1'
              >
                <div className='h6'>Tại sao bạn nên chọn chúng tôi</div>
              </div>

              <div
                className='sidebar-content'
                data-option='ft-register-member-2'
              >
              ...
              <div
                className='sidebar-content'
                data-option='ft-process-recruiter-3'
              >
                <div className='h6'>Tiến trình tuyển dụng </div>
              </div>

              <div className='sidebar-content' data-option='ft-network-4'>
                <div className='h6'>Mạng lưới kết nối ứng viên </div>
              </div>

              <div className='sidebar-content' data-option='ft-money-5'>
                <div className='h6'>Cơ hội nhận thưởng </div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className='main-content'>
            ...
            <div className='content-container'>
              ...
              <div className='list-items-container'>
                <div className='d-flex'>
                  ...
                  <div className='h6'>
                    Mỗi lượt giới thiệu thành công bạn sẽ nhận được 50 điểm
                ...
                <div className='d-flex'>
                  ...
                  <div className='h6'>
                    Quy đổi giá trị tiền thưởng tương đương hoặc dùng cho các
                    tiện ích trong hệ thống như mở hồ sơ ứng viên.
                  </div>
                </div>
              </div>
              ...
              <div className='desc-container'>
                <div className='h6'>
                  Giới thiệu càng nhiều, nhận thưởng càng lớn. Tham gia giới
                  thiệu ngay nhé!
                </div>
              </div>
            ...
            <div className='content-container'>
              ...
              <div className='list-items-container'>
                <div className='d-flex'>
                  ...
                  <div className='h6'>
                    1000+ công việc đến từ các doanh nghiệp trên thế giới được
                    cập nhật liên tục.
                  </div>
                </div>
                ...
                <div className='d-flex'>
                  ...
                  <div className='h6'>
                    500+ ngành nghề từ: phát triển phần mềm, lập trình viên,
                    phân tích dữ liệu, thiết kế, marketing, quản lý nhân sự,
                    quản lý dự án,…
                  </div>
                </div>
            ...
            <div className='content-container'>
              ...
              <div className='list-items-container'>
                <Accordion
                  ...
                  content={
                    <>
                      ...
                      &nbsp; và điền đầy đủ thông tin của mình vào mẫu. Sau đó,
                      bạn chọn đăng ký.
                    </>
                  }
                />
                ...
                <Accordion
                  ...
                  content={
                    <>
                      Bạn đăng nhập vào hệ thống. Tiếp theo, bạn chọn “Công
                      việc”. Sau đó, nhấn vào “Đang tuyển dụng”. Cuối cùng, bạn
                      tìm các vị trí có ứng viên phù hợp.
                    </>
                  }
                />
                ...
                <Accordion
                  ...
                  content={
                    <>
                      Đội ngũ Fetch kiểm tra hồ sơ ứng viên hợp lệ và tùy vào
                      từng mốc đánh giá sẽ được nhận thưởng với các mức hoa hồng
                      khác nhau. Những cập nhật mới nhất về vị trí ứng tuyển này
                      sẽ được thông báo đến tài khoản và email của bạn.
                    </>
                  }
                />
                ...
                <Accordion
                  ...
                  content={
                    <>
                      Khi bạn muốn rút tiền, bạn cần vào “Hồ sơ”, chọn “Thông
                      tin thanh toán” và nhập “Thông tin tài khoản ngân hàng”,
                      chọn “Lưu”. Nếu đã nhập Thông tin ngân hàng trước đó, bạn
                      có thể bỏ qua bước này.
                      <br /> Sau đó, bạn chọn “Rút tiền” trong “Giao dịch” ở
                      thanh bên trái, chọn “Đổi điểm thưởng”, nhập số điểm bạn
                      bạn muốn đổi chọn “Xác nhận”.
                    </>
                  }
                />
              </div>
            ...
            <div className='content-container'>
              ...
              <div className='list-items-container'>
                ...
                <div className='d-flex'>
                  ...
                  <div className='h6'>
                    Quản lý tiến trình tuyển dụng ứng viên trên hệ thống một
          ...
          >
            ...
            <div className='content-container'>
              ...
              <div className='desc-container'>
                <div className='h6'>
                  Là nơi kết nối, trao đổi hồ sơ ứng viên giữa các nhà tuyển
                  dụng với nhau. Tại đây:
                </div>
              </div>
              ...
              <div className='list-items-container'>
                <div className='d-flex'>
                  ...
                  <div className='h6'>
                    1000+ ứng viên, với nhiều ngành nghề khác nhau giúp bạn
                    thoải mái lựa chọn hồ sơ mà bạn đang tìm kiếm.
                  </div>
                </div>
                ...
                <div className='d-flex'>
                  ...
                  <div className='h6'>
                    Tích hợp bộ lọc thông minh, giúp bạn dễ dàng tìm được ứng
                    viên phù hợp, tiết kiệm thời gian, chi phí và loại bỏ sớm
          ...
          <div className='referral-policy-container'>
            <div className='benifit-container'>
              ...
              <div className='content-desc list-item-content'>
                Nhận 50 điểm thưởng tương đương 50.000đ khi giới thiệu bạn bè
                lần đầu tải Fetchunt và liên kết ngân hàng thành công từ đường
                liên kết (mã) giới thiệu.
              </div>
              ...
              <div className='content-desc list-item-content'>
                ...
                Fetchunt và liên kết ngân hàng thành công từ đường liên kết (mã)
                giới thiệu.
              </div>
              ...
              <div className='d-flex align-items-center content-header'>
                ...
                <div className='content-desc'>
                  Phần thưởng giới thiệu không cố định, sẽ thay đổi tùy từng
                  giai đoạn.
                </div>
              </div>
            </div>
            ...
            <div className='step-conditional-container'>
              ...
              <div className='content-header content-desc'>
                <u>Bước 1:</u> Đăng ký tài khoản mới bằng đường liên kết (mã)
                giới thiệu.
              </div>
              ...
              <div className='content-header content-desc'>
                <u>Bước 3:</u> Nhận điểm thưởng cho cả Người giới thiệu và Người
                được giới thiệu.
              </div>

              <div className='content-desc list-item-content'>
                Điểm thưởng sẽ được cộng vào Tổng điểm thưởng của tài khoản mà
                không cần thực hiện bất kỳ thao tác nào ngay khi Người giới
                thiệu nhận được tiền thưởng đầu tiên.
              </div>

              <div className='content-desc list-item-content'>
                Trường hợp quá 24h làm việc vẫn chưa nhận được điểm thưởng. Bạn
                vui lòng liên hệ Hộp trợ giúp của Fetchunt để được hỗ trợ.
              </div>
            </div>
          </div>
        </Modal>
