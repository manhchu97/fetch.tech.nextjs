          ...
          <div className='content-container'>
            ...
            <div className='list-items-container'>
              <div className='d-flex'>
                ...
                <div className='h6'>
                  Thông tin ứng viên và tuyển dụng viên được bảo mật và đảm bảo
                  sử dụng theo đúng chính sách nghiêm ngặt giữa các bên.
                </div>
              </div>
              ...
              <div className='d-flex'>
                ...
                <div className='h6'>
                  Ngăn chặn tình trạng ứng viên và tuyển dụng viên bị lộ thông
                  tin liên hệ và bị làm phiền bởi các hệ thông không đáng tin
                  cậy.
                </div>
              </div>
            </div>
          ...
          <div className='content-container'>
            ...
            <div className='list-items-container'>
              <div className='d-flex'>
                ...
                <div className='h6'>
                  Khác với các chương trình chỉ dành cho tuyển dụng viên chuyên
                  nghiệp, nền tảng của Fetchunt chào đón tất cả các đối tượng có
                  nhu cầu tìm kiếm hoặc giới thiệu việc làm trên thị trường IT
                  sôi động.
                </div>
              </div>
              ...
              <div className='d-flex'>
                ...
                <div className='h6'>
                  Bạn có thể cạnh tranh tiền thưởng công bằng khi giới thiệu
                  người thân, bạn bè, hoặc đồng nghiệp mà không cần phải lo lắng
                  rằng mình có quá ít CV hay chỉ quan tâm tới một cơ hội đặc
                  biệt nào đó.
                </div>
              </div>
            </div>
            ...
            <div className='div-center'>
              <Link href='https://portal.fetch.tech/auth/login?tab=signin'>
                <a target='_blank' rel='noopener noreferrer'>
                  <div role='button' className='card-button'>
                    Đăng ký tài khoản giới thiệu ngay{' '}
                  </div>
                </a>
              </Link>
            </div>
